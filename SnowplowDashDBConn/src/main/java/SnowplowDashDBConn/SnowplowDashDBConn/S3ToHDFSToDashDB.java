...
/**
 * Test class to push part files from S3 bucket into EMR temporary HDFS.
 * Afterwards, from the temporary HDFS, it takes the part files as
 * InputStream's, attach them to a multipart DashDB POST request (for data load
 * into a specified table). Measurement of time is taken to figure out
 * efficiency in single-thread operation.
 * 
 * @author StevenHu
 *
 */
public class S3ToHDFSToDashDB {
	...
	public static void main(String[] args) throws InterruptedException {
		new S3ToHDFSToDashDB().doMain(args);
	}
