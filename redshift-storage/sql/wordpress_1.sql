...
CREATE TABLE IF NOT EXISTS atomic.com_ironsidegroup_wordpress_1 (
	...
	"post_links"		BIGINT        ENCODE LZO,
	"post_headings"		BIGINT        ENCODE LZO,
	"post_paragraphs"	BIGINT        ENCODE LZO,
	"post_images"		BIGINT        ENCODE LZO,
	"post_videos"		BIGINT        ENCODE LZO,
	"post_length"		BIGINT        ENCODE LZO,
	"post_words"		BIGINT        ENCODE LZO,
...
COMMENT ON TABLE atomic.com_ironsidegroup_wordpress_1 IS 'iglu:com.ironsidegroup/wordpress/jsonschema/1-0-0';